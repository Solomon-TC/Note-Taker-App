...
import { createClient, withSessionValidation } from "@/lib/supabase-client";
...
/**
 * Get a page by ID with proper JSON parsing and session validation
 */
...
/**
 * Update page content with proper JSON handling, session validation, and comprehensive error handling
 */
...
/**
 * Create a new page with proper JSON handling and session validation
 */
...
/**
 * Get pages for a section with proper JSON parsing and session validation
 */
...
/**
 * Delete a page with session validation
 */
